# Comparing `tmp/playsound3-2.0.0.tar.gz` & `tmp/playsound3-2.0.0a0.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "playsound3-2.0.0.tar", last modified: Mon May  6 17:37:35 2024, max compression
+gzip compressed data, was "playsound3-2.0.0a0.tar", last modified: Mon May  6 17:23:56 2024, max compression
```

## Comparing `playsound3-2.0.0.tar` & `playsound3-2.0.0a0.tar`

### file list

```diff
@@ -1,16 +1,16 @@
-drwxr-xr-x   0 gaha      (1000) gaha      (1000)        0 2024-05-06 17:37:35.262768 playsound3-2.0.0/
--rw-r--r--   0 gaha      (1000) gaha      (1000)     1962 2024-05-06 14:15:46.000000 playsound3-2.0.0/LICENSE
--rw-r--r--   0 gaha      (1000) gaha      (1000)     2219 2024-05-06 17:37:35.262768 playsound3-2.0.0/PKG-INFO
--rw-r--r--   0 gaha      (1000) gaha      (1000)     1218 2024-05-06 17:36:40.000000 playsound3-2.0.0/README.md
-drwxr-xr-x   0 gaha      (1000) gaha      (1000)        0 2024-05-06 17:37:35.262768 playsound3-2.0.0/playsound3/
--rw-r--r--   0 gaha      (1000) gaha      (1000)       44 2024-05-06 14:32:01.000000 playsound3-2.0.0/playsound3/__init__.py
--rw-r--r--   0 gaha      (1000) gaha      (1000)     3349 2024-05-06 17:36:33.000000 playsound3-2.0.0/playsound3/playsound3.py
-drwxr-xr-x   0 gaha      (1000) gaha      (1000)        0 2024-05-06 17:37:35.262768 playsound3-2.0.0/playsound3.egg-info/
--rw-r--r--   0 gaha      (1000) gaha      (1000)     2219 2024-05-06 17:37:35.000000 playsound3-2.0.0/playsound3.egg-info/PKG-INFO
--rw-r--r--   0 gaha      (1000) gaha      (1000)      258 2024-05-06 17:37:35.000000 playsound3-2.0.0/playsound3.egg-info/SOURCES.txt
--rw-r--r--   0 gaha      (1000) gaha      (1000)        1 2024-05-06 17:37:35.000000 playsound3-2.0.0/playsound3.egg-info/dependency_links.txt
--rw-r--r--   0 gaha      (1000) gaha      (1000)       41 2024-05-06 17:37:35.000000 playsound3-2.0.0/playsound3.egg-info/requires.txt
--rw-r--r--   0 gaha      (1000) gaha      (1000)       11 2024-05-06 17:37:35.000000 playsound3-2.0.0/playsound3.egg-info/top_level.txt
--rw-r--r--   0 gaha      (1000) gaha      (1000)      207 2024-05-06 12:41:28.000000 playsound3-2.0.0/pyproject.toml
--rw-r--r--   0 gaha      (1000) gaha      (1000)       38 2024-05-06 17:37:35.262768 playsound3-2.0.0/setup.cfg
--rw-r--r--   0 gaha      (1000) gaha      (1000)     1365 2024-05-06 17:35:34.000000 playsound3-2.0.0/setup.py
...
### Comparing `playsound3-2.0.0/LICENSE` & `playsound3-2.0.0a0/LICENSE`

 * *Files identical despite different names*

### Comparing `playsound3-2.0.0/PKG-INFO` & `playsound3-2.0.0a0/PKG-INFO`
...
### Comparing `playsound3-2.0.0/playsound3/playsound3.py` & `playsound3-2.0.0a0/playsound3/playsound3.py`
...
### Comparing `playsound3-2.0.0/playsound3.egg-info/PKG-INFO` & `playsound3-2.0.0a0/playsound3.egg-info/PKG-INFO`
...
### Comparing `playsound3-2.0.0/setup.py` & `playsound3-2.0.0a0/setup.py`

# Comparing `tmp/open_telemetry_generic_v2-0.2.4.tar.gz` & `tmp/open_telemetry_generic_v2-0.3.0.tar.gz`
...
## Comparing `open_telemetry_generic_v2-0.2.4.tar` & `open_telemetry_generic_v2-0.3.0.tar`
...
### Comparing `open_telemetry_generic_v2-0.2.4/PKG-INFO` & `open_telemetry_generic_v2-0.3.0/PKG-INFO`
...
### Comparing `open_telemetry_generic_v2-0.2.4/app.py` & `open_telemetry_generic_v2-0.3.0/app.py`

 * *Files identical despite different names*

### Comparing `open_telemetry_generic_v2-0.2.4/setup.py` & `open_telemetry_generic_v2-0.3.0/setup.py`

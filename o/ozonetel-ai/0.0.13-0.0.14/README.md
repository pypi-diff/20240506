# Comparing `tmp/ozonetel-ai-0.0.13.tar.gz` & `tmp/ozonetel-ai-0.0.14.tar.gz`
...
+gzip compressed data, was "ozonetel-ai-0.0.14.tar", last modified: Mon May  6 05:53:49 2024, max compression
```

## Comparing `ozonetel-ai-0.0.13.tar` & `ozonetel-ai-0.0.14.tar`
...
+drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-06 05:53:49.084434 ozonetel-ai-0.0.14/
+-rw-r--r--   0 runner    (1001) docker     (127)     1068 2024-05-06 05:52:10.000000 ozonetel-ai-0.0.14/LICENSE
+-rw-r--r--   0 runner    (1001) docker     (127)    12689 2024-05-06 05:53:49.084434 ozonetel-ai-0.0.14/PKG-INFO
+-rw-r--r--   0 runner    (1001) docker     (127)    11908 2024-05-06 05:52:10.000000 ozonetel-ai-0.0.14/README.md
+drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-06 05:53:49.080434 ozonetel-ai-0.0.14/ozoneai/
+-rw-r--r--   0 runner    (1001) docker     (127)       57 2024-05-06 05:52:10.000000 ozonetel-ai-0.0.14/ozoneai/__init__.py
+-rw-r--r--   0 runner    (1001) docker     (127)     2446 2024-05-06 05:52:10.000000 ozonetel-ai-0.0.14/ozoneai/connector.py
+-rw-r--r--   0 runner    (1001) docker     (127)    12532 2024-05-06 05:52:10.000000 ozonetel-ai-0.0.14/ozoneai/embeddings.py
+-rw-r--r--   0 runner    (1001) docker     (127)      586 2024-05-06 05:52:10.000000 ozonetel-ai-0.0.14/ozoneai/exception.py
+-rw-r--r--   0 runner    (1001) docker     (127)      608 2024-05-06 05:52:10.000000 ozonetel-ai-0.0.14/ozoneai/models.py
+-rw-r--r--   0 runner    (1001) docker     (127)     1128 2024-05-06 05:52:10.000000 ozonetel-ai-0.0.14/ozoneai/utils.py
+drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-05-06 05:53:49.084434 ozonetel-ai-0.0.14/ozonetel_ai.egg-info/
+-rw-r--r--   0 runner    (1001) docker     (127)    12689 2024-05-06 05:53:49.000000 ozonetel-ai-0.0.14/ozonetel_ai.egg-info/PKG-INFO
+-rw-r--r--   0 runner    (1001) docker     (127)      319 2024-05-06 05:53:49.000000 ozonetel-ai-0.0.14/ozonetel_ai.egg-info/SOURCES.txt
+-rw-r--r--   0 runner    (1001) docker     (127)        1 2024-05-06 05:53:49.000000 ozonetel-ai-0.0.14/ozonetel_ai.egg-info/dependency_links.txt
+-rw-r--r--   0 runner    (1001) docker     (127)       15 2024-05-06 05:53:49.000000 ozonetel-ai-0.0.14/ozonetel_ai.egg-info/requires.txt
+-rw-r--r--   0 runner    (1001) docker     (127)        8 2024-05-06 05:53:49.000000 ozonetel-ai-0.0.14/ozonetel_ai.egg-info/top_level.txt
+-rw-r--r--   0 runner    (1001) docker     (127)       38 2024-05-06 05:53:49.084434 ozonetel-ai-0.0.14/setup.cfg
+-rw-r--r--   0 runner    (1001) docker     (127)     1407 2024-05-06 05:52:10.000000 ozonetel-ai-0.0.14/setup.py
```

### Comparing `ozonetel-ai-0.0.13/LICENSE` & `ozonetel-ai-0.0.14/LICENSE`

 * *Files identical despite different names*

### Comparing `ozonetel-ai-0.0.13/PKG-INFO` & `ozonetel-ai-0.0.14/README.md`
...
### Comparing `ozonetel-ai-0.0.13/README.md` & `ozonetel-ai-0.0.14/PKG-INFO`
...
### Comparing `ozonetel-ai-0.0.13/ozoneai/connector.py` & `ozonetel-ai-0.0.14/ozoneai/connector.py`

 * *Files identical despite different names*

### Comparing `ozonetel-ai-0.0.13/ozoneai/embeddings.py` & `ozonetel-ai-0.0.14/ozoneai/embeddings.py`
...
### Comparing `ozonetel-ai-0.0.13/ozoneai/exception.py` & `ozonetel-ai-0.0.14/ozoneai/exception.py`

 * *Files identical despite different names*

### Comparing `ozonetel-ai-0.0.13/ozoneai/models.py` & `ozonetel-ai-0.0.14/ozoneai/models.py`

 * *Files identical despite different names*

### Comparing `ozonetel-ai-0.0.13/ozonetel_ai.egg-info/PKG-INFO` & `ozonetel-ai-0.0.14/ozonetel_ai.egg-info/PKG-INFO`
...
### Comparing `ozonetel-ai-0.0.13/setup.py` & `ozonetel-ai-0.0.14/setup.py`

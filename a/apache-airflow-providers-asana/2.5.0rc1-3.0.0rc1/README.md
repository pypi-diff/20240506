# Comparing `tmp/apache_airflow_providers_asana-2.5.0rc1.tar.gz` & `tmp/apache-airflow-providers-asana-3.0.0rc1.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "apache_airflow_providers_asana-2.5.0rc1.tar", last modified: Tue Apr 30 11:18:50 2024, max compression
...
## Comparing `apache_airflow_providers_asana-2.5.0rc1.tar` & `apache-airflow-providers-asana-3.0.0rc1.tar`

### file list

```diff
@@ -1,11 +1,28 @@
--rw-r--r--   0        0        0     3046 2024-04-30 11:18:50.000000 apache_airflow_providers_asana-2.5.0rc1/README.rst
--rw-r--r--   0        0        0    13569 2024-04-30 11:18:50.000000 apache_airflow_providers_asana-2.5.0rc1/airflow/providers/asana/LICENSE
--rw-r--r--   0        0        0      779 2024-04-30 11:18:50.000000 apache_airflow_providers_asana-2.5.0rc1/airflow/providers/asana/README.md
--rw-r--r--   0        0        0     1580 2024-04-30 11:18:50.000000 apache_airflow_providers_asana-2.5.0rc1/airflow/providers/asana/__init__.py
--rw-r--r--   0        0        0     2445 2024-04-30 11:18:50.000000 apache_airflow_providers_asana-2.5.0rc1/airflow/providers/asana/get_provider_info.py
--rw-r--r--   0        0        0      787 2024-04-30 11:18:50.000000 apache_airflow_providers_asana-2.5.0rc1/airflow/providers/asana/hooks/__init__.py
--rw-r--r--   0        0        0    12406 2024-04-30 11:18:50.000000 apache_airflow_providers_asana-2.5.0rc1/airflow/providers/asana/hooks/asana.py
--rw-r--r--   0        0        0      787 2024-04-30 11:18:50.000000 apache_airflow_providers_asana-2.5.0rc1/airflow/providers/asana/operators/__init__.py
--rw-r--r--   0        0        0     5491 2024-04-30 11:18:50.000000 apache_airflow_providers_asana-2.5.0rc1/airflow/providers/asana/operators/asana_tasks.py
--rw-r--r--   0        0        0     2960 2024-04-30 11:18:50.000000 apache_airflow_providers_asana-2.5.0rc1/pyproject.toml
--rw-r--r--   0        0        0     4735 1970-01-01 00:00:00.000000 apache_airflow_providers_asana-2.5.0rc1/PKG-INFO
...
### Comparing `apache_airflow_providers_asana-2.5.0rc1/airflow/providers/asana/LICENSE` & `apache-airflow-providers-asana-3.0.0rc1/LICENSE`
...
### Comparing `apache_airflow_providers_asana-2.5.0rc1/airflow/providers/asana/README.md` & `apache-airflow-providers-asana-3.0.0rc1/airflow/providers/asana/__init__.py`
...
### Comparing `apache_airflow_providers_asana-2.5.0rc1/airflow/providers/asana/__init__.py` & `apache-airflow-providers-asana-3.0.0rc1/setup.py`
...
### Comparing `apache_airflow_providers_asana-2.5.0rc1/airflow/providers/asana/get_provider_info.py` & `apache-airflow-providers-asana-3.0.0rc1/airflow/providers/asana/get_provider_info.py`
...
### Comparing `apache_airflow_providers_asana-2.5.0rc1/airflow/providers/asana/hooks/__init__.py` & `apache-airflow-providers-asana-3.0.0rc1/airflow/providers/asana/hooks/__init__.py`

 * *Files identical despite different names*

### Comparing `apache_airflow_providers_asana-2.5.0rc1/airflow/providers/asana/hooks/asana.py` & `apache-airflow-providers-asana-3.0.0rc1/airflow/providers/asana/hooks/asana.py`
...
### Comparing `apache_airflow_providers_asana-2.5.0rc1/airflow/providers/asana/operators/__init__.py` & `apache-airflow-providers-asana-3.0.0rc1/airflow/providers/asana/operators/__init__.py`

 * *Files identical despite different names*

### Comparing `apache_airflow_providers_asana-2.5.0rc1/airflow/providers/asana/operators/asana_tasks.py` & `apache-airflow-providers-asana-3.0.0rc1/airflow/providers/asana/operators/asana_tasks.py`

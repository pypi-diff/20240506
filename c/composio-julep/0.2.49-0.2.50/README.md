# Comparing `tmp/composio_julep-0.2.49.tar.gz` & `tmp/composio_julep-0.2.50.tar.gz`
...
## Comparing `composio_julep-0.2.49.tar` & `composio_julep-0.2.50.tar`
...
### Comparing `composio_julep-0.2.49/PKG-INFO` & `composio_julep-0.2.50/PKG-INFO`
...
### Comparing `composio_julep-0.2.49/README.md` & `composio_julep-0.2.50/README.md`

 * *Files identical despite different names*

### Comparing `composio_julep-0.2.49/composio_julep/julep_toolspec.py` & `composio_julep-0.2.50/composio_julep/julep_toolspec.py`

 * *Files identical despite different names*

### Comparing `composio_julep-0.2.49/composio_julep.egg-info/PKG-INFO` & `composio_julep-0.2.50/composio_julep.egg-info/PKG-INFO`
...
### Comparing `composio_julep-0.2.49/setup.py` & `composio_julep-0.2.50/setup.py`

# Comparing `tmp/codeanim-0.0.24.tar.gz` & `tmp/codeanim-0.0.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "codeanim-0.0.24.tar", max compression
+gzip compressed data, was "codeanim-0.0.9.tar", max compression
```

## Comparing `codeanim-0.0.24.tar` & `codeanim-0.0.9.tar`

### file list

```diff
@@ -1,13 +1,12 @@
--rw-r--r--   0        0        0     1068 2024-05-06 21:15:27.899846 codeanim-0.0.24/LICENSE
--rw-r--r--   0        0        0     2263 2024-05-06 21:15:27.899846 codeanim-0.0.24/README.md
--rw-r--r--   0        0        0      408 2024-05-06 21:15:27.899846 codeanim-0.0.24/pyproject.toml
--rwxr-xr-x   0        0        0     2773 2024-05-06 21:15:27.899846 codeanim-0.0.24/src/codeanim/__init__.py
--rw-r--r--   0        0        0     1719 2024-05-06 21:15:27.899846 codeanim-0.0.24/src/codeanim/chrome.py
--rw-r--r--   0        0        0     4203 2024-05-06 21:15:27.899846 codeanim-0.0.24/src/codeanim/core.py
--rw-r--r--   0        0        0     1152 2024-05-06 21:15:27.899846 codeanim-0.0.24/src/codeanim/delayer.py
--rw-r--r--   0        0        0      751 2024-05-06 21:15:27.899846 codeanim-0.0.24/src/codeanim/interpolators.py
--rw-r--r--   0        0        0     1674 2024-05-06 21:15:27.899846 codeanim-0.0.24/src/codeanim/keyboard.py
--rw-r--r--   0        0        0     1338 2024-05-06 21:15:27.899846 codeanim-0.0.24/src/codeanim/markdown.py
--rw-r--r--   0        0        0     1058 2024-05-06 21:15:27.899846 codeanim-0.0.24/src/codeanim/shell.py
--rw-r--r--   0        0        0     3018 2024-05-06 21:15:27.899846 codeanim-0.0.24/src/codeanim/vscode.py
--rw-r--r--   0        0        0     2683 1970-01-01 00:00:00.000000 codeanim-0.0.24/PKG-INFO
...
### Comparing `codeanim-0.0.24/LICENSE` & `codeanim-0.0.9/LICENSE`

 * *Files identical despite different names*

### Comparing `codeanim-0.0.24/src/codeanim/__init__.py` & `codeanim-0.0.9/src/codeanim/__init__.py`
...
### Comparing `codeanim-0.0.24/src/codeanim/chrome.py` & `codeanim-0.0.9/src/codeanim/chrome.py`
...
### Comparing `codeanim-0.0.24/src/codeanim/delayer.py` & `codeanim-0.0.9/src/codeanim/delayer.py`

 * *Files identical despite different names*

### Comparing `codeanim-0.0.24/src/codeanim/markdown.py` & `codeanim-0.0.9/src/codeanim/markdown.py`

 * *Files identical despite different names*

### Comparing `codeanim-0.0.24/src/codeanim/shell.py` & `codeanim-0.0.9/src/codeanim/shell.py`

 * *Files identical despite different names*

### Comparing `codeanim-0.0.24/src/codeanim/vscode.py` & `codeanim-0.0.9/src/codeanim/vscode.py`
...
### Comparing `codeanim-0.0.24/PKG-INFO` & `codeanim-0.0.9/PKG-INFO`

# Comparing `tmp/unimernet-0.0.6-py2.py3-none-any.whl.zip` & `tmp/unimernet-0.0.7-py2.py3-none-any.whl.zip`

## zipinfo {}

```diff
@@ -1,10 +1,9 @@
-Zip file size: 2223231 bytes, number of entries: 70
+Zip file size: 2222926 bytes, number of entries: 69
 -rw-r--r--  2.0 unx     2134 b- defN 80-Jan-01 00:00 demo.py
--rw-r--r--  2.0 unx      217 b- defN 80-Jan-01 00:00 run_streamlit_app.py
...
--rw-r--r--  2.0 unx    11342 b- defN 80-Jan-01 00:00 unimernet-0.0.6.dist-info/LICENSE
--rw-r--r--  2.0 unx     5534 b- defN 80-Jan-01 00:00 unimernet-0.0.6.dist-info/METADATA
--rw-r--r--  2.0 unx       92 b- defN 80-Jan-01 00:00 unimernet-0.0.6.dist-info/WHEEL
--rw-r--r--  2.0 unx      110 b- defN 80-Jan-01 00:00 unimernet-0.0.6.dist-info/entry_points.txt
-?rw-r--r--  2.0 unx     6570 b- defN 16-Jan-01 00:00 unimernet-0.0.6.dist-info/RECORD
-70 files, 2596388 bytes uncompressed, 2212613 bytes compressed:  14.8%
...
-Filename: unimernet-0.0.6.dist-info/LICENSE
+Filename: unimernet-0.0.7.dist-info/LICENSE
 Comment: 
 
-Filename: unimernet-0.0.6.dist-info/METADATA
+Filename: unimernet-0.0.7.dist-info/METADATA
 Comment: 
 
-Filename: unimernet-0.0.6.dist-info/WHEEL
+Filename: unimernet-0.0.7.dist-info/WHEEL
 Comment: 
 
-Filename: unimernet-0.0.6.dist-info/entry_points.txt
+Filename: unimernet-0.0.7.dist-info/entry_points.txt
 Comment: 
 
-Filename: unimernet-0.0.6.dist-info/RECORD
...
## Comparing `unimernet-0.0.6.dist-info/LICENSE` & `unimernet-0.0.7.dist-info/LICENSE`

 * *Files identical despite different names*

## Comparing `unimernet-0.0.6.dist-info/METADATA` & `unimernet-0.0.7.dist-info/METADATA`
...
## Comparing `unimernet-0.0.6.dist-info/RECORD` & `unimernet-0.0.7.dist-info/RECORD`
...
-run_streamlit_app.py,sha256=a1CU-de5QxP7BbDDRX_s8FsvISKDNQlUNvdQslw1rjw,217
...
-unimernet-0.0.6.dist-info/LICENSE,sha256=l0-K-Od_DnsxSadei3hwQHq_dgykSc49eSt2aRiHwnE,11342
-unimernet-0.0.6.dist-info/METADATA,sha256=jKIXL3gIO2HQchz5Zyt2JICQQiPpGgX4wRPIs-Cv-TQ,5534
-unimernet-0.0.6.dist-info/WHEEL,sha256=IrRNNNJ-uuL1ggO5qMvT1GGhQVdQU54d6ZpYqEZfEWo,92
-unimernet-0.0.6.dist-info/entry_points.txt,sha256=mtRH69iuooNcFHcHB_WrD8h0fgNYB3iQlBuzRiL3CUk,110
-unimernet-0.0.6.dist-info/RECORD,,

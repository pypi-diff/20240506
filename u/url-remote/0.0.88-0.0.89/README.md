# Comparing `tmp/url_remote-0.0.88.tar.gz` & `tmp/url_remote-0.0.89.tar.gz`
...
## Comparing `url_remote-0.0.88.tar` & `url_remote-0.0.89.tar`
...
### Comparing `url_remote-0.0.88/README.md` & `url_remote-0.0.89/README.md`

 * *Files identical despite different names*

### Comparing `url_remote-0.0.88/setup.py` & `url_remote-0.0.89/setup.py`
...
### Comparing `url_remote-0.0.88/url_remote/src/action_name_enum.py` & `url_remote-0.0.89/url_remote/src/action_name_enum.py`

 * *Files identical despite different names*

### Comparing `url_remote-0.0.88/url_remote/src/component_name_enum.py` & `url_remote-0.0.89/url_remote/src/component_name_enum.py`

 * *Files identical despite different names*

### Comparing `url_remote-0.0.88/url_remote/src/url_circlez.py` & `url_remote-0.0.89/url_remote/src/url_circlez.py`

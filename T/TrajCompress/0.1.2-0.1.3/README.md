# Comparing `tmp/trajcompress-0.1.2.tar.gz` & `tmp/trajcompress-0.1.3.tar.gz`
...
## Comparing `trajcompress-0.1.2.tar` & `trajcompress-0.1.3.tar`
...
### Comparing `trajcompress-0.1.2/LICENSE` & `trajcompress-0.1.3/LICENSE`

 * *Files identical despite different names*

### Comparing `trajcompress-0.1.2/TrajCompress/__init__.py` & `trajcompress-0.1.3/TrajCompress/__init__.py`

 * *Files identical despite different names*

### Comparing `trajcompress-0.1.2/tests/test_sample.py` & `trajcompress-0.1.3/tests/test_sample.py`

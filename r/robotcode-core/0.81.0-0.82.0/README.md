# Comparing `tmp/robotcode_core-0.81.0.tar.gz` & `tmp/robotcode_core-0.82.0.tar.gz`
...
### Comparing `robotcode_core-0.81.0/pyproject.toml` & `robotcode_core-0.82.0/pyproject.toml`

# Comparing `tmp/korean_news_crawler-1.0.2.tar.gz` & `tmp/korean_news_crawler-1.0.3.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "korean_news_crawler-1.0.2.tar", last modified: Mon May  6 09:20:47 2024, max compression
+gzip compressed data, was "korean_news_crawler-1.0.3.tar", last modified: Mon May  6 09:22:32 2024, max compression
```

## Comparing `korean_news_crawler-1.0.2.tar` & `korean_news_crawler-1.0.3.tar`

### file list

```diff
@@ -1,12 +1,15 @@
-drwxrwxrwx   0        0        0        0 2024-05-06 09:20:48.000000 korean_news_crawler-1.0.2/
--rw-rw-rw-   0        0        0    22931 2024-05-06 09:20:48.000000 korean_news_crawler-1.0.2/PKG-INFO
--rw-rw-rw-   0        0        0    22391 2024-05-06 08:26:28.000000 korean_news_crawler-1.0.2/README.md
-drwxrwxrwx   0        0        0        0 2024-05-06 09:20:48.000000 korean_news_crawler-1.0.2/korean_news_crawler.egg-info/
--rw-rw-rw-   0        0        0    22931 2024-05-06 09:20:48.000000 korean_news_crawler-1.0.2/korean_news_crawler.egg-info/PKG-INFO
--rw-rw-rw-   0        0        0      257 2024-05-06 09:20:48.000000 korean_news_crawler-1.0.2/korean_news_crawler.egg-info/SOURCES.txt
--rw-rw-rw-   0        0        0        1 2024-05-06 09:20:48.000000 korean_news_crawler-1.0.2/korean_news_crawler.egg-info/dependency_links.txt
--rw-rw-rw-   0        0        0       24 2024-05-06 09:20:48.000000 korean_news_crawler-1.0.2/korean_news_crawler.egg-info/requires.txt
--rw-rw-rw-   0        0        0        1 2024-05-06 09:20:48.000000 korean_news_crawler-1.0.2/korean_news_crawler.egg-info/top_level.txt
--rw-rw-rw-   0        0        0      108 2023-10-27 04:01:28.000000 korean_news_crawler-1.0.2/pyproject.toml
--rw-rw-rw-   0        0        0       86 2024-05-06 09:20:48.000000 korean_news_crawler-1.0.2/setup.cfg
--rw-rw-rw-   0        0        0      909 2024-05-06 09:20:22.000000 korean_news_crawler-1.0.2/setup.py
...
### Comparing `korean_news_crawler-1.0.2/PKG-INFO` & `korean_news_crawler-1.0.3/PKG-INFO`
...
```diff
@@ -1,8 +1,8 @@
-Metadata-Version: 2.1 Name: korean_news_crawler Version: 1.0.2 Summary: Python
...
### Comparing `korean_news_crawler-1.0.2/README.md` & `korean_news_crawler-1.0.3/README.md`

 * *Files identical despite different names*

### Comparing `korean_news_crawler-1.0.2/korean_news_crawler.egg-info/PKG-INFO` & `korean_news_crawler-1.0.3/korean_news_crawler.egg-info/PKG-INFO`
...
```diff
@@ -1,8 +1,8 @@
-Metadata-Version: 2.1 Name: korean-news-crawler Version: 1.0.2 Summary: Python
...
### Comparing `korean_news_crawler-1.0.2/setup.py` & `korean_news_crawler-1.0.3/setup.py`

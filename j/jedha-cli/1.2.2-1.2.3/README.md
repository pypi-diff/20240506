# Comparing `tmp/jedha_cli-1.2.2.tar.gz` & `tmp/jedha_cli-1.2.3.tar.gz`
...
## Comparing `jedha_cli-1.2.2.tar` & `jedha_cli-1.2.3.tar`
...
### Comparing `jedha_cli-1.2.2/LICENSE` & `jedha_cli-1.2.3/LICENSE`

 * *Files identical despite different names*

### Comparing `jedha_cli-1.2.2/README.md` & `jedha_cli-1.2.3/README.md`

 * *Files identical despite different names*

### Comparing `jedha_cli-1.2.2/pyproject.toml` & `jedha_cli-1.2.3/pyproject.toml`
...
### Comparing `jedha_cli-1.2.2/src/labs/covering-tracks.yaml` & `jedha_cli-1.2.3/src/labs/covering-tracks.yaml`

 * *Files identical despite different names*

### Comparing `jedha_cli-1.2.2/src/labs/dns_zone_transfer.yaml` & `jedha_cli-1.2.3/src/labs/dns_zone_transfer.yaml`

 * *Files identical despite different names*

### Comparing `jedha_cli-1.2.2/src/labs/docker_evasion_1.yaml` & `jedha_cli-1.2.3/src/labs/docker_evasion_1.yaml`

 * *Files identical despite different names*

### Comparing `jedha_cli-1.2.2/src/labs/pentesting_network_services.yaml` & `jedha_cli-1.2.3/src/labs/pentesting_network_services.yaml`

 * *Files identical despite different names*

### Comparing `jedha_cli-1.2.2/src/labs/pivoting.yaml` & `jedha_cli-1.2.3/src/labs/pivoting.yaml`

 * *Files identical despite different names*

### Comparing `jedha_cli-1.2.2/src/labs/smb_server.yaml` & `jedha_cli-1.2.3/src/labs/smb_server.yaml`

 * *Files identical despite different names*

### Comparing `jedha_cli-1.2.2/src/labs/sqli.yaml` & `jedha_cli-1.2.3/src/labs/sqli.yaml`

 * *Files identical despite different names*

### Comparing `jedha_cli-1.2.2/src/labs/ssrf.yaml` & `jedha_cli-1.2.3/src/labs/ssrf.yaml`

 * *Files identical despite different names*

### Comparing `jedha_cli-1.2.2/src/labs/template_injection.yaml` & `jedha_cli-1.2.3/src/labs/template_injection.yaml`

 * *Files identical despite different names*

### Comparing `jedha_cli-1.2.2/src/labs/vuln_web_app.yaml` & `jedha_cli-1.2.3/src/labs/vuln_web_app.yaml`

 * *Files identical despite different names*

### Comparing `jedha_cli-1.2.2/src/labs/vulnerable_and_outdated_software.yaml` & `jedha_cli-1.2.3/src/labs/vulnerable_and_outdated_software.yaml`

 * *Files identical despite different names*

### Comparing `jedha_cli-1.2.2/src/labs.yaml` & `jedha_cli-1.2.3/src/labs.yaml`

 * *Files 6% similar despite different names*

```diff
@@ -48,17 +48,23 @@
   description: A login page has been set up. Can you bypass it?
 - name: insecure_design
   ip: "10.10.3.22"
   description: Sometimes, the problem seats between the chair and the keyboard.
 - name: security_misconfiguration
   ip: "10.10.3.23"
   description: A misconfiguration has been found. Can you exploit it?
-- name: vulnerable_and_outdated_software
-  ip: ""
-  description: Find as many flags as you can!
+- name: "cms_dragon"
+  ip: "10.10.3.24"
+  description: "A vulnerable CMS."
+- name: "golden_club"
+  ip: "10.10.3.25"
+  description: "A vulnerable web application."
+- name: "jwt_integrity"
+  ip: "10.10.3.26"
+  description: "A JWT vulnerable web application."
 - name: linux_privesc
   ip: "10.10.3.27"
   description: Escalate your privileges to root! You can start with "ssh Creed@10.10.3.27" and "Mescaline".
 - name: suid
   ip: "10.10.3.31"
   description: 'Will you be able to exploit a SUID binary to get the final flag? (username and password: "jedha")'
 - name: suid_2
```

### Comparing `jedha_cli-1.2.2/src/main.py` & `jedha_cli-1.2.3/src/main.py`

 * *Files identical despite different names*

### Comparing `jedha_cli-1.2.2/src/misc.py` & `jedha_cli-1.2.3/src/misc.py`

 * *Files identical despite different names*

### Comparing `jedha_cli-1.2.2/PKG-INFO` & `jedha_cli-1.2.3/PKG-INFO`

# Comparing `tmp/botasaurus2-1.4.7.tar.gz` & `tmp/botasaurus2-1.4.8.tar.gz`
...
### Comparing `botasaurus2-1.4.7/botasaurus/anti_detect_driver.py` & `botasaurus2-1.4.8/botasaurus/anti_detect_driver.py`

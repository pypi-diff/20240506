# Comparing `tmp/InternEvo-0.4.2.tar.gz` & `tmp/InternEvo-0.4.3.tar.gz`
...
### Comparing `InternEvo-0.4.2/InternEvo.egg-info/SOURCES.txt` & `InternEvo-0.4.3/InternEvo.egg-info/SOURCES.txt`
...
### Comparing `InternEvo-0.4.2/internlm/data/tokenized/packed_dataset.py` & `InternEvo-0.4.3/internlm/data/tokenized/packed_dataset.py`
...
### Comparing `InternEvo-0.4.2/internlm/model/moe/moe.py` & `InternEvo-0.4.3/internlm/model/moe/moe.py`
...
### Comparing `InternEvo-0.4.2/internlm/train/pipeline.py` & `InternEvo-0.4.3/internlm/train/pipeline.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.2/internlm/train/utils.py` & `InternEvo-0.4.3/internlm/train/utils.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.2/internlm/utils/common.py` & `InternEvo-0.4.3/internlm/utils/common.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.2/internlm/utils/gputest.py` & `InternEvo-0.4.3/internlm/utils/gputest.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.2/internlm/utils/logger.py` & `InternEvo-0.4.3/internlm/utils/logger.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.2/internlm/utils/megatron_timers.py` & `InternEvo-0.4.3/internlm/utils/megatron_timers.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.2/internlm/utils/parallel.py` & `InternEvo-0.4.3/internlm/utils/parallel.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.2/internlm/utils/registry.py` & `InternEvo-0.4.3/internlm/utils/registry.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.2/internlm/utils/simple_memory_profiler.py` & `InternEvo-0.4.3/internlm/utils/simple_memory_profiler.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.2/internlm/utils/storage_manager.py` & `InternEvo-0.4.3/internlm/utils/storage_manager.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.2/internlm/utils/timeout.py` & `InternEvo-0.4.3/internlm/utils/timeout.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.2/internlm/utils/utils.py` & `InternEvo-0.4.3/internlm/utils/utils.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.2/internlm/utils/writer.py` & `InternEvo-0.4.3/internlm/utils/writer.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.2/setup.py` & `InternEvo-0.4.3/setup.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.2/tests/common_fixture.py` & `InternEvo-0.4.3/tests/common_fixture.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.2/tests/test_core/test_pipeline.py` & `InternEvo-0.4.3/tests/test_core/test_pipeline.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.2/tests/test_core/utils.py` & `InternEvo-0.4.3/tests/test_core/utils.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.2/tests/test_training/7B_check_acc.py` & `InternEvo-0.4.3/tests/test_training/7B_check_acc.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.2/tests/test_training/7B_check_init.py` & `InternEvo-0.4.3/tests/test_training/7B_check_init.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.2/tests/test_training/test_forward_output_no_fa.py` & `InternEvo-0.4.3/tests/test_training/test_forward_output_no_fa.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.2/tests/test_training/test_load_ckpt_loss.py` & `InternEvo-0.4.3/tests/test_training/test_load_ckpt_loss.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.2/tests/test_training/test_loss.py` & `InternEvo-0.4.3/tests/test_training/test_loss.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.2/tests/test_training/test_no_fa_train_temp.py` & `InternEvo-0.4.3/tests/test_training/test_no_fa_train_temp.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.2/tests/test_training/test_norm_weight.py` & `InternEvo-0.4.3/tests/test_training/test_norm_weight.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.2/tests/test_training/test_swap_nb_loss_and_gradnorm.py` & `InternEvo-0.4.3/tests/test_training/test_swap_nb_loss_and_gradnorm.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.2/tests/test_training/train_CI.py` & `InternEvo-0.4.3/tests/test_training/train_CI.py`

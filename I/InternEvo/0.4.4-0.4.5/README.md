# Comparing `tmp/InternEvo-0.4.4.tar.gz` & `tmp/InternEvo-0.4.5.tar.gz`
...
### Comparing `InternEvo-0.4.4/InternEvo.egg-info/SOURCES.txt` & `InternEvo-0.4.5/InternEvo.egg-info/SOURCES.txt`
...
### Comparing `InternEvo-0.4.4/internlm/data/tokenized/packed_dataset.py` & `InternEvo-0.4.5/internlm/data/tokenized/packed_dataset.py`
...
### Comparing `InternEvo-0.4.4/internlm/model/moe/moe.py` & `InternEvo-0.4.5/internlm/model/moe/moe.py`
...
### Comparing `InternEvo-0.4.4/internlm/train/pipeline.py` & `InternEvo-0.4.5/internlm/train/pipeline.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.4/internlm/train/utils.py` & `InternEvo-0.4.5/internlm/train/utils.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.4/internlm/utils/common.py` & `InternEvo-0.4.5/internlm/utils/common.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.4/internlm/utils/gputest.py` & `InternEvo-0.4.5/internlm/utils/gputest.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.4/internlm/utils/logger.py` & `InternEvo-0.4.5/internlm/utils/logger.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.4/internlm/utils/megatron_timers.py` & `InternEvo-0.4.5/internlm/utils/megatron_timers.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.4/internlm/utils/parallel.py` & `InternEvo-0.4.5/internlm/utils/parallel.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.4/internlm/utils/registry.py` & `InternEvo-0.4.5/internlm/utils/registry.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.4/internlm/utils/simple_memory_profiler.py` & `InternEvo-0.4.5/internlm/utils/simple_memory_profiler.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.4/internlm/utils/storage_manager.py` & `InternEvo-0.4.5/internlm/utils/storage_manager.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.4/internlm/utils/timeout.py` & `InternEvo-0.4.5/internlm/utils/timeout.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.4/internlm/utils/utils.py` & `InternEvo-0.4.5/internlm/utils/utils.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.4/internlm/utils/writer.py` & `InternEvo-0.4.5/internlm/utils/writer.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.4/setup.py` & `InternEvo-0.4.5/setup.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.4/tests/common_fixture.py` & `InternEvo-0.4.5/tests/common_fixture.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.4/tests/test_core/test_pipeline.py` & `InternEvo-0.4.5/tests/test_core/test_pipeline.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.4/tests/test_core/utils.py` & `InternEvo-0.4.5/tests/test_core/utils.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.4/tests/test_training/7B_check_acc.py` & `InternEvo-0.4.5/tests/test_training/7B_check_acc.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.4/tests/test_training/7B_check_init.py` & `InternEvo-0.4.5/tests/test_training/7B_check_init.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.4/tests/test_training/test_forward_output_no_fa.py` & `InternEvo-0.4.5/tests/test_training/test_forward_output_no_fa.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.4/tests/test_training/test_load_ckpt_loss.py` & `InternEvo-0.4.5/tests/test_training/test_load_ckpt_loss.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.4/tests/test_training/test_loss.py` & `InternEvo-0.4.5/tests/test_training/test_loss.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.4/tests/test_training/test_no_fa_train_temp.py` & `InternEvo-0.4.5/tests/test_training/test_no_fa_train_temp.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.4/tests/test_training/test_norm_weight.py` & `InternEvo-0.4.5/tests/test_training/test_norm_weight.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.4/tests/test_training/test_swap_nb_loss_and_gradnorm.py` & `InternEvo-0.4.5/tests/test_training/test_swap_nb_loss_and_gradnorm.py`

 * *Files identical despite different names*

### Comparing `InternEvo-0.4.4/tests/test_training/train_CI.py` & `InternEvo-0.4.5/tests/test_training/train_CI.py`

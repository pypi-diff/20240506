# Comparing `tmp/BioSAK-1.88.2.tar.gz` & `tmp/BioSAK-1.88.3.tar.gz`
...
### Comparing `BioSAK-1.88.2/BioSAK/sampling_GTDB_gnms.py` & `BioSAK-1.88.3/BioSAK/sampling_GTDB_gnms.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.88.2/BioSAK/select_seq.py` & `BioSAK-1.88.3/BioSAK/select_seq.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.88.2/BioSAK/sep_reads_by_barcode.py` & `BioSAK-1.88.3/BioSAK/sep_reads_by_barcode.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.88.2/BioSAK/slice_seq.py` & `BioSAK-1.88.3/BioSAK/slice_seq.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.88.2/BioSAK/split_fasta.py` & `BioSAK-1.88.3/BioSAK/split_fasta.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.88.2/BioSAK/split_folder.py` & `BioSAK-1.88.3/BioSAK/split_folder.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.88.2/BioSAK/split_sam.py` & `BioSAK-1.88.3/BioSAK/split_sam.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.88.2/BioSAK/submitHPC.py` & `BioSAK-1.88.3/BioSAK/submitHPC.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.88.2/BioSAK/subset_GTDB_meta.py` & `BioSAK-1.88.3/BioSAK/subset_GTDB_meta.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.88.2/BioSAK/subset_df.py` & `BioSAK-1.88.3/BioSAK/subset_df.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.88.2/BioSAK/subset_tree.py` & `BioSAK-1.88.3/BioSAK/subset_tree.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.88.2/BioSAK/tmp_1.py` & `BioSAK-1.88.3/BioSAK/tmp_1.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.88.2/BioSAK/top_16S_hits.py` & `BioSAK-1.88.3/BioSAK/top_16S_hits.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.88.2/BioSAK/top_hits_in_a_group.py` & `BioSAK-1.88.3/BioSAK/top_hits_in_a_group.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.88.2/BioSAK/transpose.py` & `BioSAK-1.88.3/BioSAK/transpose.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.88.2/BioSAK/usearch_uc.py` & `BioSAK-1.88.3/BioSAK/usearch_uc.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.88.2/BioSAK/wilcox.py` & `BioSAK-1.88.3/BioSAK/wilcox.py`

 * *Files identical despite different names*

### Comparing `BioSAK-1.88.2/BioSAK.egg-info/SOURCES.txt` & `BioSAK-1.88.3/BioSAK.egg-info/SOURCES.txt`

 * *Files identical despite different names*

### Comparing `BioSAK-1.88.2/LICENSE` & `BioSAK-1.88.3/LICENSE`

 * *Files identical despite different names*

### Comparing `BioSAK-1.88.2/README.md` & `BioSAK-1.88.3/README.md`

 * *Files identical despite different names*

### Comparing `BioSAK-1.88.2/bin/BioSAK` & `BioSAK-1.88.3/bin/BioSAK`

 * *Files identical despite different names*

### Comparing `BioSAK-1.88.2/setup.py` & `BioSAK-1.88.3/setup.py`

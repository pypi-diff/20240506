# Comparing `tmp/simple_build_system-1.1.1.tar.gz` & `tmp/simple_build_system-1.1.2.tar.gz`
...
### Comparing `simple_build_system-1.1.1/src/_simple_build_system/data/cmake/ExtDep_pybind11.cmake` & `simple_build_system-1.1.2/src/_simple_build_system/data/cmake/ExtDep_pybind11.cmake`
...
### Comparing `simple_build_system-1.1.1/src/_simple_build_system/makefile.py` & `simple_build_system-1.1.2/src/_simple_build_system/makefile.py`
...
### Comparing `simple_build_system-1.1.1/src/_simple_build_system/pkgfilter.py` & `simple_build_system-1.1.2/src/_simple_build_system/pkgfilter.py`

 * *Files identical despite different names*

### Comparing `simple_build_system-1.1.1/src/_simple_build_system/pkgutils.py` & `simple_build_system-1.1.2/src/_simple_build_system/pkgutils.py`

 * *Files identical despite different names*

### Comparing `simple_build_system-1.1.1/src/_simple_build_system/replace.py` & `simple_build_system-1.1.2/src/_simple_build_system/replace.py`

 * *Files identical despite different names*

### Comparing `simple_build_system-1.1.1/src/_simple_build_system/singlecfg.py` & `simple_build_system-1.1.2/src/_simple_build_system/singlecfg.py`

 * *Files identical despite different names*

### Comparing `simple_build_system-1.1.1/src/_simple_build_system/target_base.py` & `simple_build_system-1.1.2/src/_simple_build_system/target_base.py`

 * *Files identical despite different names*

### Comparing `simple_build_system-1.1.1/src/_simple_build_system/target_builder.py` & `simple_build_system-1.1.2/src/_simple_build_system/target_builder.py`

 * *Files identical despite different names*

### Comparing `simple_build_system-1.1.1/src/_simple_build_system/testlauncher.py` & `simple_build_system-1.1.2/src/_simple_build_system/testlauncher.py`

 * *Files identical despite different names*

### Comparing `simple_build_system-1.1.1/src/_simple_build_system/testxml.py` & `simple_build_system-1.1.2/src/_simple_build_system/testxml.py`

 * *Files identical despite different names*

### Comparing `simple_build_system-1.1.1/src/_simple_build_system/tfact_binary.py` & `simple_build_system-1.1.2/src/_simple_build_system/tfact_binary.py`

 * *Files identical despite different names*

### Comparing `simple_build_system-1.1.1/src/_simple_build_system/tfact_headerdeps.py` & `simple_build_system-1.1.2/src/_simple_build_system/tfact_headerdeps.py`

 * *Files identical despite different names*

### Comparing `simple_build_system-1.1.1/src/_simple_build_system/tfact_libavail.py` & `simple_build_system-1.1.2/src/_simple_build_system/tfact_libavail.py`

 * *Files identical despite different names*

### Comparing `simple_build_system-1.1.1/src/_simple_build_system/tfact_prepinc.py` & `simple_build_system-1.1.2/src/_simple_build_system/tfact_prepinc.py`

 * *Files identical despite different names*

### Comparing `simple_build_system-1.1.1/src/_simple_build_system/tfact_pyinit.py` & `simple_build_system-1.1.2/src/_simple_build_system/tfact_pyinit.py`

 * *Files identical despite different names*

### Comparing `simple_build_system-1.1.1/src/_simple_build_system/tfact_reflogs.py` & `simple_build_system-1.1.2/src/_simple_build_system/tfact_reflogs.py`

 * *Files identical despite different names*

### Comparing `simple_build_system-1.1.1/src/_simple_build_system/tfact_symlink.py` & `simple_build_system-1.1.2/src/_simple_build_system/tfact_symlink.py`

 * *Files identical despite different names*

### Comparing `simple_build_system-1.1.1/src/_simple_build_system/utils.py` & `simple_build_system-1.1.2/src/_simple_build_system/utils.py`

 * *Files identical despite different names*

### Comparing `simple_build_system-1.1.1/src/simple_build_system.egg-info/PKG-INFO` & `simple_build_system-1.1.2/src/simple_build_system.egg-info/PKG-INFO`
...
### Comparing `simple_build_system-1.1.1/src/simple_build_system.egg-info/SOURCES.txt` & `simple_build_system-1.1.2/src/simple_build_system.egg-info/SOURCES.txt`
